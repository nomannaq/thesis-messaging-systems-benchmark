...
# Define all four brokers - now using 100KB message size
brokers = ["Kafka", "RabbitMQ", "Pulsar", "Redpanda"]
message_size = "100KB"  # Changed to 100KB
...
print("Loading and standardizing 100KB message size data files...")
all_data = {}
...
def create_line_charts():
    ...
    fig.update_layout(
        title_text='Messaging Broker Comparison - 100KB Message Size (14 Minutes Standardized)',  # Updated title
...
def create_bar_charts():
    ...
    fig.update_layout(
        title_text='100KB Message Size: Four Broker Performance Comparison (14 Minutes Standardized) - Averages',  # Updated title
...
def create_box_plots():
    ...
    fig.update_layout(
        title_text='100KB Message Size: Statistical Distribution of Performance Metrics (14 Minutes Standardized)',  # Updated title
...
def create_memory_line_graph():
    ...
    fig.update_layout(
        title='100KB Message Size: Memory Usage Over Time (14 Minutes Standardized)',  # Updated title
...
def create_radar_chart():
    ...
    fig.update_layout(
        ...
        title='100KB Message Size: Normalized Broker Performance Comparison (14 Minutes Standardized)',  # Updated title
        height=700,
        template=plotly_dark_template,
...
app.title = "Messaging Broker Dashboard - 100KB"  # Updated title
...
app.layout = html.Div(style={'backgroundColor': '#181b1f', 'color': '#d8d9da', 'padding': '20px'}, children=[
    ...
    html.Div(className="header no-break section-container", children=[
        html.H1(
            children='Messaging Broker Performance Dashboard (100KB - 14 Mins Standardized)',  # Updated title
