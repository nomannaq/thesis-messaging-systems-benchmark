...
# Define all four brokers - now using 10KB message size
brokers = ["Kafka", "RabbitMQ", "Pulsar", "Redpanda"]
message_size = "10KB"  # Changed to 10KB
standard_duration = 840  # 14 minutes in seconds

# Define file paths for different brokers (10KB only)
file_paths = {
    "Kafka": "/Users/noumanqureshi/Downloads/csc-things/kafka-2.csv",    # Update path to 10KB file
    "RabbitMQ": "/Users/noumanqureshi/Downloads/csc-things/rabbitmq-10240.csv", # Update path to 10KB file
    "Pulsar": "/Users/noumanqureshi/Downloads/csc-things/pulsar2.csv",      # Update path to 10KB file
    "Redpanda": "/Users/noumanqureshi/Downloads/csc-things/redpanda2.csv"   # Update path to 10KB file
}
...
print("Loading and standardizing 10KB message size data files...")
all_data = {}
...
def create_line_charts():
    ...
    fig.update_layout(
        title_text='Messaging Broker Comparison - 10KB Message Size (14 Minutes Standardized)',  # Updated title
...
def create_bar_charts():
    ...
    fig.update_layout(
        title_text='10KB Message Size: Four Broker Performance Comparison (14 Minutes Standardized) - Averages',  # Updated title
...
def create_box_plots():
    ...
    fig.update_layout(
        title_text='10KB Message Size: Statistical Distribution of Performance Metrics (14 Minutes Standardized)',  # Updated title
...
def create_memory_line_graph():
    ...
    fig.update_layout(
        title='10KB Message Size: Memory Usage Over Time (14 Minutes Standardized)',  # Updated title
...
def create_radar_chart():
    ...
    fig.update_layout(
        ...
        title='10KB Message Size: Normalized Broker Performance Comparison (14 Minutes Standardized)',  # Updated title
        height=700,
        template=plotly_dark_template,
...
app.title = "Messaging Broker Dashboard - 10KB"  # Updated title
...
app.layout = html.Div(style={'backgroundColor': '#181b1f', 'color': '#d8d9da', 'padding': '20px'}, children=[
    ...
    html.Div(className="header no-break section-container", children=[
        html.H1(
            children='Messaging Broker Performance Dashboard (10KB - 14 Mins Standardized)',  # Updated title
